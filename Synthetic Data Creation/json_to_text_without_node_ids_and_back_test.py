...
def process_json_files(directory):
    ...
    for json_file in json_files:
        ...
        try:
            ...
            text_without_ids = json_to_text_with_node_text(json_data, essay)
            
            # Convert text back to JSON
            converted_json_data = text_without_ids_to_json(text_without_ids)
            ...
            if not isomorphic:
                ...
                with open('without_node_ids/' + fname + '_with_node_text.txt', 'w') as file:
                    file.write(text_without_ids)
